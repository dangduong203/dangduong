		...
		void nhap() 
 		...
 		void tieude()
	 	{
 			cout<<setw(15)<<"Ho ten"<<setw(20)
			 	<<setw(22)<<"Ngay Thang Nam"<<setw(20)
			 	<<setw(30)<<"Can cuoc cong dan "<<setw(20)
			 	<<setw(20)<<"Ho khau thuong tru"<<setw(20)<<endl; 
 		} 
 		void xuat()
 		{
 			tieude(); 
		 	cout<<setw(15)<<ht<<setw(20)
			 	<<setw(20)<<ngaysinh.ngay<<"/"<<ngaysinh.thang<<"/"<<ngaysinh.nam<<setw(20)
			 	<<setw(25)<<cccd<<setw(20)
